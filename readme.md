...
+ Managed remote staff/contractors, timelines, releases, and team workload
...
Consulting for financial services and healthcare clients
...
### Asynchrony, World Wide Technology
__Senior Software Engineer, Tech Lead__ _October 2007 to June 2022_ (levelled from Entry to Senior in 5 years)

Consulting for clients in financial services, government, quick service restaurant, and healthcare industries

+ Led multiple teams and trained staff in company culture and development practices
...
+ Built and delivered internal projects and libraries
...
+ **Languages** Kotlin, Groovy, Rust, Swift, Dart, Bash, JavaScript

+ **Frameworks** Android SDK/NDK, Compose, iOS, Flutter, React, Tokio, Axum, Spring Boot

+ **Database** PostgreSQL, SQLite, Room, Diesel, Flyway, Spring Data JPA

+ **DevOps** Jenkins, GitHub, GitLab, Automation, Networking, OSI Model

+ **Testing** JUnit, Mockito, Spock, Espresso, Robolectric

+ **Design** Clean Architecture, MVVM, MVP, BLoC, SOLID

+ **OS** Linux, BSD, AOSP, macOS, Windows

+ **Tools** JetBrains IDEs, XCode, VSCode, Visual Studio, Docker
